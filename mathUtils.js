...
export function addTwoNumbers(aNumber, anotherNumber) {
    
    return aNumber + anotherNumber;
}

export function multiplyTwoNumbers(someMultiple, someOtherMultiple) {
    return someMultiple * someOtherMultiple;
}
